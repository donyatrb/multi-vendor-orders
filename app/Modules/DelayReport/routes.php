...
Route::post('order-delay-report/{delayedOrdersQueue}', [DelayReportController::class, 'update']);
Route::get('order-delay-report/vendors/weekly', [DelayReportController::class, 'vendorsWeeklyReport']);
